...
const Page = () => {
    ...
    return (
        <div className="profile sm:bg-gray-50">
            <div className="flex overflow-hidden">
                <SideBar />
                <NavBar />
                <div className="flex-grow md:w-3/4  mt-20 md:mt-0">
                    <div className="mx-4 min-h-screen max-w-screen-xl">
                        <div className="col-span-8 overflow-hidden rounded-xl sm:bg-gray-50 sm:px-8">
                            <div className="pt-4">
                            ...
                            <p className="mt-2">Can`t remember your current password. <span className="text-sm font-semibold text-blue-600 underline decoration-2" >Recover Account</span></p>
